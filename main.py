...
# bot = Bot()
# bot.login(username='asilbek_26_', password='asilbek_26_')

# bot.upload_photo("123123.jpg", caption='Automating post to insta')
...
upload(r"C:\Users\Asilbek\Desktop\kikout\chezol.mp4")
# ================================================================
